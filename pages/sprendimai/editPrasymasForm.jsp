...
<html:form action="editprasymas" method="post">
...
<tr>
	...
	<td>
		...
		<input type="button" value="Pridëti asmená ..." class="button" onclick="openPopup('addpersonform.do?mode=1')" style="width: 100px;" />
				<logic:present name="deletingEmtptyGv"><br /><span class="error">Trinamas asmuo nedeklaravæs gyvenamosios vietos</span></logic:present>
