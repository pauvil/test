...
<div class="heading">Paþyma apie mirusio asmens paskutinæ deklaruotà gyvenamàjà vietà</div>
<table class="form" cellpadding="2" cellspacing="1" width="100%">
<html:form action="mirepazyma" method="get">
<tr>
	<td width="50"></td>
...
<tr>
	<td></td>
	<td><b> Mirusio asmens kodas:</b></td>
	<td>
		<html:text property="asmKodas" styleClass="inputFixed" maxlength="11" style="width: 220px;" />
		<logic:present name="errAsmKodas"><span class="error">Negaliojantis asmens kodas</span></logic:present>
		<logic:present name="error.asmuoNeMires"><br /><span class="error">Ðis asmuo nëra miræs</span></logic:present>
		<logic:present name="error.neprieinamas"><span class="error">Negalima suformuoti paþymos. Asmens gyvenamoji vieta deklaruota kitoje savivaldybëje.</span></logic:present>
	</td>
</tr>
<tr>
	<%-- <td></td>
